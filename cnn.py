...
names = ['cats','dogs','horses','humans','houses','nature','hill','sea','building','village']
...
# Testing a new image
test_image = cv2.imread('data/Dataset/1.png')
...
#print(y_pred)
target_names = ['class 0(Cats)', 'class 1(Dogs)', 'class 2(Horses)','class 3(Humans)','class 4(Houses)','class 5(Nature)','class 6(Hill)','class 7(Sea)','class 8(Building)','class 9(Village)']
